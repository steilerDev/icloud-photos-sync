...
import * as WEB_SERVER_ERR from './codes/web-server.js';
export {APP_ERR, ARCHIVE_ERR, AUTH_ERR, ICLOUD_PHOTOS_ERR, LIBRARY_ERR, MFA_ERR, QUERY_PARSER_ERR, RESOURCES_ERR, SYNC_ERR, VALIDATOR_ERR, WEB_SERVER_ERR};
