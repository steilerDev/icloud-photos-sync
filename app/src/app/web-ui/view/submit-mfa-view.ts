...
export class SubmitMfaView extends View {
    protected override get content(): string {
        return `
            ...
            <button id="resendButton" class="inverted" onclick="navigate('/request-mfa')">Resend Code/Change Method</button>
            <button id="cancelButton" class="inverted" onclick="navigate('/state')">Cancel</button>
        `;
    }
